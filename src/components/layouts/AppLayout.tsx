...
const navItems = [
  { to: '/billing',       icon: ShoppingCart, tKey: 'nav.billing',     roles: ['admin', 'cashier', 'super_admin'] },
  { to: '/products',      icon: Package,      tKey: 'nav.products',    roles: ['admin', 'cashier'] },
  { to: '/branches',      icon: Building2,    tKey: 'nav.branches',    roles: ['admin'] },
  { to: '/suppliers',     icon: Truck,        tKey: 'nav.suppliers',   roles: ['admin'] },
  { to: '/reports',       icon: BarChart2,    tKey: 'nav.reports',     roles: ['admin', 'cashier'] },
  { to: '/users',         icon: Users,        tKey: 'nav.users',       roles: ['admin'] },
  { to: '/shop-profile',  icon: Store,        tKey: 'nav.shop_profile',roles: ['admin'] },
  { to: '/super-admin',   icon: ShieldCheck,  tKey: 'nav.super_admin', roles: ['super_admin'] },
  { to: '/settings',      icon: Settings,     tKey: 'nav.settings',    roles: ['admin'] },
];
      ...
      <nav className="flex-1 px-3 py-3 space-y-1 overflow-y-auto">
        {visibleItems.map(({ to, icon: Icon, tKey }) => (
          ...
          >
            ...
            <span className="truncate flex-1">{t(tKey)}</span>
